...
namespace WalletConfig
{
    ...
    const std::string_view addressPrefix = "cHaD";

    /* Your coins 'Ticker', e.g. Monero = XMR, Bitcoin = BTC */
    const std::string ticker = "CHAD";
    ...
    const std::string daemonName = "ChadCoind";

    /* The name to call this wallet */
    const std::string walletName = "chadwallet";
    ...
    const std::string contactLink = "https://discord.gg/QVMsYcrvug";
